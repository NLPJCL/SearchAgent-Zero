...
python -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5-3b-instruct_searchr1_origin' \
    ...
    trainer.default_local_dir='./output/qwen2.5-3b-instruct_searchr1_origin'  2>&1 | tee ./logs/qwen2.5-3b-instruct_searchr1_origin.log
