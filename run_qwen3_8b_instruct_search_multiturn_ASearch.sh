...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3-8b-instruct_ASearch_abnormal_trajectory_filter_ca}"
...
# - seq_max_k2 can be re-enabled to reject sequences with extreme chi-square spikes
